...
def visualize_se2_examples():
    ...
    local_shape = np.array([[0, 0], [2, 0], [2, 1], [0, 1], [0, 0]])  # Rectangle
    ...
    ax3.arrow(
        frame_origin[0], frame_origin[1], frame_x[0], frame_x[1], head_width=0.1, head_length=0.1, fc="red", ec="red"
    )
    ax3.arrow(
        frame_origin[0], frame_origin[1], frame_y[0], frame_y[1], head_width=0.1, head_length=0.1, fc="red", ec="red"
    )
    ...
    # Draw SE2 frames
    for se2, color, label in [(se2_1, "blue", "SE2_1"), (se2_2, "green", "SE2_2"), (se2_composed, "red", "Composed")]:
