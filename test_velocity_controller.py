...
class TestVelocityController(unittest.TestCase):
    ...
    def test_calculate_stopping_distance_normal_velocity(self):
        ...
        velocity = 4.0  # m/s
        expected_distance = (velocity ** 2) / (2 * self.controller.max_deceleration) * self.controller.conservative_braking_factor
    ...
    def test_calculate_stopping_distance_negative_velocity(self):
        ...
        velocity = -3.0  # m/s
        expected_distance = (abs(velocity) ** 2) / (2 * self.controller.max_deceleration) * self.controller.conservative_braking_factor
    ...
    def test_calculate_max_velocity_for_distance_normal_distance_forward(self):
        ...
        expected_velocity = max(min(expected_velocity, self.controller.max_forward_velocity), self.controller.min_velocity)
    ...
    def test_calculate_max_velocity_for_distance_normal_distance_backward(self):
        ...
        expected_velocity = max(min(expected_velocity, self.controller.max_backward_velocity), self.controller.min_velocity)
